...
let duration = 5000;
let str = ['FELIZ', 'ANO', 'NOVO' , '2023' , 'PROLAM', 'MANAUS', 'GILBERTO', 'KARLA', 'CISSA', 'BIA', 'SULAMITA', 'JUNIOR', 'INGRID', 'ELIZABETH', 'EVANDRO', 'ANDRESSA', 'ALEX', 'DESEJO', 'MUITO', 'SUCESSO', 'MARCELL'];
